...
const proposition = Array.from(document.getElementsByClassName('proposition'));
console.log(proposition);
console.log(proposition[1].style.backgroundColor == '');
...
function changeColor (target){
    if (target.style.backgroundColor != colors[indexColor]){
        target.style.backgroundColor = colors[indexColor]
        indexColor++
...
// clique sur 'proposition'
proposition.forEach(function(event){

    event.addEventListener('click',function(test){

        if(proposition.some(test => test.style.backgroundColor != '' )){
            console.log('il y en a un qui nest pas blanc')
            console.log(test.srcElement);
            console.log(event)
        } else {
            console.log('cest bon tu peux modifier ton choix ou choisir')
            changeColor(event);
        }
